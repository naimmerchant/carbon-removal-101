      ...
      <main className="main-content">
        ...
        {page === "about" && (
          <div style={{ animation: "fadeUp 0.5s ease both" }}>
            ...
            {/* Credits */}
            <section style={{ marginTop: 64, paddingBottom: 20 }}>
              <div style={{
                fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 20, fontWeight: 700,
              ...
              <div style={{ display: "flex", gap: 24, marginTop: 10, flexWrap: "wrap" }}>
                {[
                  ...
                  { name: "Grant Faber", url: "https://www.linkedin.com/in/grfaber/" },
                ].map(person => (
                  <a key={person.name} href={person.url} target="_blank" rel="noopener noreferrer" style={{
                    display: "inline-flex", alignItems: "center", gap: 7,
                    fontSize: 15, fontWeight: 500, color: "#2a2822", textDecoration: "none",
                    transition: "color 0.2s",
                  }}
                  onMouseEnter={e => e.currentTarget.style.color = "#3b6b1e"}
                  onMouseLeave={e => e.currentTarget.style.color = "#2a2822"}
                  >
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style={{ flexShrink: 0, opacity: 0.6 }}>
